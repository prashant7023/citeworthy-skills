...
def main():
    ...
    find = Findings("render-extraction-audit", "parse")
    ...
    if not docs:
        ...
        print("render-extraction-audit: no analysable pages")
        return
    ...
    print(f"render-extraction-audit: {len(find.items)} finding(s) across {total} page(s); "
