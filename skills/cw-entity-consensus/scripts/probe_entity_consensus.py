...
def main():
    ...
    find = Findings("cw-entity-consensus", "trust")
    ...
    if not docs:
        ...
        print("cw-entity-consensus: no analysable pages")
        return
    ...
    print(f"cw-entity-consensus: {len(find.items)} finding(s); brand='{brand_name}'; "
          f"phase={args.phase}")
