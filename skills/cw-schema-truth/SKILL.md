...
- As step 4 of `cw-audit-conductor`, alongside `cw-quotability`, which
...
9. Write `findings/cw-schema-truth.json`.
...
`findings/cw-schema-truth.json`, pillar `extract`.
