...
Page type is inferred deterministically by `crawl-access-audit` and stored in the bundle.
...
which also satisfies the corroboration requirement in `entity-corroboration-audit`.
