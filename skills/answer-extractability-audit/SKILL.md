---
name: answer-extractability-audit
description: >-
...
- As step 4 of `audit-orchestrator`, alongside `structured-data-audit`.
...
is separate from `structured-data-audit`: the failure modes are different, and so are
...
12. Write `findings/answer-extractability-audit.json`.
...
`findings/answer-extractability-audit.json`, pillar `extract`.
