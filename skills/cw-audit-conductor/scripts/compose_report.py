...
SKILL_ORDER = [
    "cw-reach-gate", "cw-render-gap", "cw-schema-truth",
    "cw-quotability", "cw-entity-consensus",
    "cw-time-decay", "cw-arrival-experience",
]
...
def render_markdown(report):
    ...
    lines = [
        f"# Citeworthy Audit: {report['site']}", "",
        f"**Audited:** {report['audited_at']}  ",
        (f"**Overall Citeworthy score:** {summary['citeworthy_score']}/100  "
         if summary.get("citeworthy_score") is not None
         else "**Overall Citeworthy score:** not reported (audit inconclusive)  "),
